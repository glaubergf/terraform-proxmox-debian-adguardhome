...
variable "motd_adguardhome_path" {
  description = "Caminho para o arquivo de MOTD do AdGuard Home"
  type        = string
}
...
variable "disable_systemd_resolved_path" {
  description = "Caminho para o script que desabilita o systemd-resolved"
  type        = string
}

variable "backup_adguard_path" {
  description = "Caminho para o script de backup do AdGuard Home"
  type        = string
}

variable "cronjob_path" {
  description = "Caminho para o script do cronjob"
  type        = string
}

variable "restore_adguard_path" {
  description = "Caminho para o script de restauração do AdGuard Home"
  type        = string
}